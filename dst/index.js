...
var makeColormap = function makeColormap(name, options) {
  ...
  var start, middle;
  if (mode === 'dark') {
    start = chroma__default["default"]('#1b1e23').brighten(0);
  ...
  switch (name) {
    ...
    case 'warm':
      correctLightness = true;
      if (mode === 'dark') {
        var preRamp = [chroma__default["default"](purple).darken(0.9), chroma__default["default"](pink).darken(0.6), chroma__default["default"](red).darken(0.3), chroma__default["default"](orange), chroma__default["default"](yellow).brighten(0.3)];
